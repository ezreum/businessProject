...
public class Empleado {
	...
	public Empleado(String nombre2, String direccion2, String tipo2, int cod_depar1) {
		super();
		this.nombre = nombre2;
	...
	public String toString() {
		return "Empleado [nombre=" + nombre + ", direccion=" + direccion + ", tipo=" + tipo + ", cod_depar=" + cod_depar
				+ ", cod_depar1=" + cod_depar1 + "]";
	}
